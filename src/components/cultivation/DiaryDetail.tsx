  ...
  return (
    <div className="mt-3 flex flex-col gap-3">
      ...
      <Group
        ...
        // ⚠ 빈 칸일 때 **까닭**을 적는다. 그냥 비워 두면 사용자는 기능이 고장
        //   났다고 여긴다 — 실제로 "리포트를 봤는데 왜 안 붙느냐" 는 물음이
        //   나왔다(2026-09-20).
        //
        //   비는 길이 둘이다. 그날 리포트가 아직 없었거나, 그날 **다른 줄에
        //   이미 붙어** 있거나다(하루에 한 줄에만 박는다 — actions 의
        //   `dayFirstAdvice`). 둘을 가르려면 화면이 그날 다른 줄을 알아야 하는데,
        //   그 말은 이 컴포넌트가 하루치를 통째로 받아야 한다는 뜻이다.
        //   **그만한 값이 없어** 한 문장으로 둔다.
        noteKo={
          entry.adviceTextKo === null
            ? "그날 리포트가 없거나, 같은 날 다른 기록에 붙어 있습니다"
            : "우리가 남기는 값"
        }
        titleKo="AI 조언"
      />
